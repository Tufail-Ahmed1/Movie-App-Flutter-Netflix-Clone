...
class TopRateSeriesModel {
  ...
  factory TopRateSeriesModel.fromRawJson(String str) => TopRateSeriesModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TopRateSeriesModel.fromJson(Map<String, dynamic> json) => TopRateSeriesModel(
    page: json["page"],
